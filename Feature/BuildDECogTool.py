            ...
            for file_name in dir_list:
                if file_name == folder_path.split('_')[-1].split('/')[0]:
                    for sub_path, sub_file_name, sub_file_list in os.walk(os.path.join(origin_path, file_name)):
                        file_cnt += 1
                        print('Currently processed to {}，total progress {}/{}'.format(file_name, file_cnt, len(dir_list)))
                        cog_num = 0
...
# Approach to the delineation of the dataset 1
# Cross-subject division
...
# Approach to the delineation of the dataset 2
# Inter-subject division
...
# dataSet inheritance definition
