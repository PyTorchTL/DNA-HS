...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes, in_channels, args):
        super().__init__()
...
def resnet18(num_classes=10, dropout=0, in_channels=5, args=None):
    """ return a ResNet 18 object
    """
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=args.num_classes, in_channels=in_channels, args=args)
